...
# Meta-analyses script for burdens
    ...
    # Takes in .assoc files generated by RVTests
        # python AMPNIH_UKB_CASES_PROXIES_meta_analysis_numvar.py \
        #             --test [SkatO, CMC] \
...
if test == "SkatO": 
    ...
    ukb_sib_numvar.columns = ['GENE', 'UKB_PARENT_PROXY_NUMVAR']
...
data_frames = [amp_nih_raw_df, ukb_cases_raw_df, ukb_sib_raw_df, ukb_parent_raw_df]
...
numvar_data_frames = [amp_nih_numvar, ukb_numvar, ukb_sib_numvar, ukb_parent_numvar]
total_numvars = pd.concat(numvar_data_frames)
final_dataframe = merge_pvals.merge(total_numvars, how='outer', on=['GENE']).fillna('NA')
