...
# Meta-analyses script for burdens
    ...
    # Takes in .assoc files generated by RVTests
        # python gne_AMPNIH_UKB_CASES_PROXIES_noSIB_meta_analysis_numvar.py \
        #             --test [SkatO, CMCWald] \
...
data_frames = [ukb_cases_raw_df, amp_nih_raw_df, ukb_parent_raw_df, gne_df]
#ukb_sib_raw_df,

original_pval_df = ukb_cases_raw_df.merge(amp_nih_raw_df,on='Gene', how="outer").merge(ukb_parent_raw_df,on='Gene', how="outer").merge(gne_df,on='Gene', how="outer").fillna("NA")
# merge(ukb_sib_raw_df, on='Gene', how="outer").
...
total_numvars = ukb_numvar.merge(amp_nih_numvar, on='GENE', how="outer").merge(ukb_parent_numvar, on='GENE', how="outer").merge(gne_numvar, on='GENE', how="outer").fillna("NA")
# .merge(ukb_sib_numvar, on='GENE', how="outer")
