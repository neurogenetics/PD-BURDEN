...
if test == "SkatO": 
    ...
    # Drop the unncessary columns, leaving just GENE and P-VALUE
    print(f"Dropping unneccesary columns...")
    ukb_all_cases_raw_df.drop(columns=['RANGE','N_INFORMATIVE','NumVar','NumPolyVar','NonRefSite','BETA','SE'], inplace=True)
...
#original_pval_df = ukb_all_cases_raw_df.merge(amp_nih_raw_df,on='Gene', how="outer").merge(gne_df, on='Gene', how="outer").fillna("NA")
